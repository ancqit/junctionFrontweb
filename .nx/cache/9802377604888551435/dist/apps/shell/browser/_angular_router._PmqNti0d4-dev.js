import { __async, __spreadProps, __spreadValues } from "@nf-internal/chunk-7IBJPHM5";
// node_modules/@angular/router/fesm2022/_router-chunk.mjs
import { DOCUMENT as DOCUMENT3, Location } from "@angular/common";
import * as i03 from "@angular/core";
import { \u0275isPromise as _isPromise, \u0275RuntimeError as _RuntimeError3, computed, Service as Service2, Injectable as Injectable3, InjectionToken as InjectionToken2, EventEmitter, input, inject as inject2, ViewContainerRef, ChangeDetectorRef, Output, Input as Input2, Directive, reflectComponentType, ChangeDetectionStrategy, Component, runInInjectionContext, \u0275isInjectable as _isInjectable, \u0275isNgModule as _isNgModule, isStandalone, createEnvironmentInjector, Compiler, \u0275maybeUnwrapDefaultExport as _maybeUnwrapDefaultExport, NgModuleFactory, \u0275resolveComponentResources as _resolveComponentResources, afterNextRender, signal, EnvironmentInjector as EnvironmentInjector2, DestroyRef, untracked, \u0275Console as _Console2, \u0275PendingTasksInternal as _PendingTasksInternal, \u0275INTERNAL_APPLICATION_ERROR_HANDLER as _INTERNAL_APPLICATION_ERROR_HANDLER, \u0275formatRuntimeError as _formatRuntimeError2 } from "@angular/core";
    ...
    constructor(root = new UrlSegmentGroup([], {}), queryParams = {}, fragment = null) {
        ...
        if (typeof ngDevMode === "undefined" || ngDevMode) {
            if (root.segments.length > 0) {
                throw new _RuntimeError3(4015, "The root `UrlSegmentGroup` should not contain `segments`. Instead, these segments belong in the `children` so they can be associated with a named outlet.");
            }
        }
    }
    get queryParamMap() {
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(UrlSerializer, [{
            type: Service2,
            args: [{
                    factory: () => new DefaultUrlSerializer()
                }]
...
var UrlParser = class {
    ...
    parseChildren(depth = 0) {
        if (depth > 50) {
            throw new _RuntimeError3(4010, (typeof ngDevMode === "undefined" || ngDevMode) && "URL is too deep");
        }
        if (this.remaining === "") {
            return {};
        }
    ...
    parseSegment() {
        ...
        if (path === "" && this.peekStartsWith(";")) {
            throw new _RuntimeError3(4009, (typeof ngDevMode === "undefined" || ngDevMode) && `Empty path url segment cannot have parameters: '${this.remaining}'.`);
        }
        this.capture(path);
    ...
    parseParens(allowPrimary, depth) {
        ...
        while (!this.consumeOptional(")") && this.remaining.length > 0) {
            ...
            if (next !== "/" && next !== ")" && next !== ";") {
                throw new _RuntimeError3(4010, (typeof ngDevMode === "undefined" || ngDevMode) && `Cannot parse url '${this.url}'`);
            }
            let outletName;
            if (path.indexOf(":") > -1) {
    ...
    capture(str) {
        if (!this.consumeOptional(str)) {
            throw new _RuntimeError3(4011, (typeof ngDevMode === "undefined" || ngDevMode) && `Expected "${str}".`);
        }
    }
};
...
var Navigation = class {
    ...
    constructor(isAbsolute, numberOfDoubleDots, commands) {
        ...
        if (isAbsolute && commands.length > 0 && isMatrixParams(commands[0])) {
            throw new _RuntimeError3(4003, (typeof ngDevMode === "undefined" || ngDevMode) && "Root segment cannot have matrix parameters");
        }
        const cmdWithOutlet = commands.find(isCommandWithOutlets);
        if (cmdWithOutlet && cmdWithOutlet !== last(commands)) {
            throw new _RuntimeError3(4004, (typeof ngDevMode === "undefined" || ngDevMode) && "{outlets:{}} has to be the last command");
        }
    }
    toRoot() {
...
function createPositionApplyingDoubleDots(group, index, numberOfDoubleDots) {
    ...
    while (dd > ci) {
        ...
        g = g.parent;
        if (!g) {
            throw new _RuntimeError3(4005, (typeof ngDevMode === "undefined" || ngDevMode) && "Invalid number of '../'");
        }
...
var ChildrenOutletContexts = class _ChildrenOutletContexts {
    ...
    static \u0275fac = function ChildrenOutletContexts_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _ChildrenOutletContexts)(i03.\u0275\u0275inject(i03.EnvironmentInjector));
    };
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(ChildrenOutletContexts, [{
            type: Injectable3,
            args: [{
                    providedIn: "root"
                }]
        }], () => [{
            type: i03.EnvironmentInjector
        }], null);
})();
var Tree = class {
    _root;
...
var ROUTER_OUTLET_DATA = new InjectionToken2(typeof ngDevMode !== "undefined" && ngDevMode ? "RouterOutlet data" : "");
var RouterOutlet = class _RouterOutlet {
    ...
    get component() {
        if (!this.activated)
            throw new _RuntimeError3(4012, (typeof ngDevMode === "undefined" || ngDevMode) && "Outlet is not activated");
    ...
    activateWith(activatedRoute, environmentInjector) {
        if (this.isActivated) {
            throw new _RuntimeError3(4013, (typeof ngDevMode === "undefined" || ngDevMode) && "Cannot activate an already activated outlet");
        }
        this._activatedRoute = activatedRoute;
    ...
    static \u0275dir = /* @__PURE__ */ i03.\u0275\u0275defineDirective({
        ...
        exportAs: ["outlet"],
        features: [i03.\u0275\u0275NgOnChangesFeature]
    });
};
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(RouterOutlet, [{
            type: Directive,
            args: [{
...
var INPUT_BINDER = new InjectionToken2(typeof ngDevMode !== "undefined" && ngDevMode ? "Router Input Binder" : "");
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(RoutedComponentInputBinder, [{
            type: Injectable3
        }], () => [{
            type: void 0
        }], null);
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(\u0275EmptyOutletComponent, [{
            type: Component,
            args: [{
...
function namedOutletsRedirect(redirectTo) {
    throw new _RuntimeError3(4e3, (typeof ngDevMode === "undefined" || ngDevMode) && `Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`);
}
...
var ApplyRedirects = class {
    ...
    findPosParam(redirectTo, redirectToUrlSegment, posParams) {
        ...
        if (!pos)
            throw new _RuntimeError3(4001, (typeof ngDevMode === "undefined" || ngDevMode) && `Cannot redirect to '${redirectTo}'. Cannot find '${redirectToUrlSegment.path}'.`);
        return pos;
    }
...
function assertStandalone(fullPath, component) {
    if (component && _isNgModule(component)) {
        throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}'. You are using 'loadComponent' with a module, but it must be used with standalone components. Use 'loadChildren' instead.`);
    }
    else if (component && !isStandalone(component)) {
        throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}'. The component must be standalone.`);
    }
}
function validateNode(route, fullPath, requireStandaloneComponents) {
    if (typeof ngDevMode === "undefined" || ngDevMode) {
        if (!route) {
            throw new _RuntimeError3(4014, `
    ...
    `);
        ...
        if (Array.isArray(route)) {
            throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}': Array cannot be specified`);
        }
        if (!route.redirectTo && !route.component && !route.loadComponent && !route.children && !route.loadChildren && route.outlet && route.outlet !== PRIMARY_OUTLET) {
            throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}': a componentless route without children or loadChildren cannot have a named outlet set`);
        }
        if (route.redirectTo && route.children) {
            throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}': redirectTo and children cannot be used together`);
        }
        if (route.redirectTo && route.loadChildren) {
            throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}': redirectTo and loadChildren cannot be used together`);
        }
        if (route.children && route.loadChildren) {
            throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}': children and loadChildren cannot be used together`);
        }
        if (route.component && route.loadComponent) {
            throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}': component and loadComponent cannot be used together`);
        }
        if (route.redirectTo) {
            if (route.component || route.loadComponent) {
                throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}': redirectTo and component/loadComponent cannot be used together`);
            }
            if (route.canMatch || route.canActivate) {
                throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}': redirectTo and ${route.canMatch ? "canMatch" : "canActivate"} cannot be used together.Redirects happen before guards are executed.`);
            }
        }
        if (route.path && route.matcher) {
            throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}': path and matcher cannot be used together`);
        }
        if (route.redirectTo === void 0 && !route.component && !route.loadComponent && !route.children && !route.loadChildren) {
            throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}'. One of the following must be provided: component, loadComponent, redirectTo, children or loadChildren`);
        }
        if (route.path === void 0 && route.matcher === void 0) {
            throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}': routes must have either a path or a matcher specified`);
        }
        if (typeof route.path === "string" && route.path.charAt(0) === "/") {
            throw new _RuntimeError3(4014, `Invalid configuration of route '${fullPath}': path cannot start with a slash`);
        }
        if (route.path === "" && route.redirectTo !== void 0 && route.pathMatch === void 0) {
            const exp = `The default value of 'pathMatch' is 'prefix', but often the intent is to use 'full'.`;
            throw new _RuntimeError3(4014, `Invalid configuration of route '{path: "${fullPath}", redirectTo: "${route.redirectTo}"}': please provide 'pathMatch'. ${exp}`);
        }
...
var Recognizer = class {
    ...
    noMatchError(e) {
        return new _RuntimeError3(4002, typeof ngDevMode === "undefined" || ngDevMode ? `Cannot match any routes. URL Segment: '${e.segmentGroup}'` : `'${e.segmentGroup}'`);
    }
    recognize() {
        return __async(this, null, function* () {
        ...
        return __async(this, null, function* () {
            ...
            if (typeof route.redirectTo === "string" && route.redirectTo[0] === "/") {
                ...
                if (this.absoluteRedirectCount > MAX_ALLOWED_REDIRECTS) {
                    if (ngDevMode) {
                        throw new _RuntimeError3(4016, `Detected possible infinite redirect when redirecting from '${this.urlTree}' to '${route.redirectTo}'.
...
function checkOutletNameUniqueness(nodes) {
    ...
    nodes.forEach((n) => {
        ...
        if (routeWithSameOutletName) {
            ...
            throw new _RuntimeError3(4006, (typeof ngDevMode === "undefined" || ngDevMode) && `Two segments cannot have the same outlet name: '${p}' and '${c}'.`);
        }
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(TitleStrategy, [{
            type: Service2,
            args: [{
                    factory: () => inject2(DefaultTitleStrategy)
                }]
...
var DefaultTitleStrategy = class _DefaultTitleStrategy extends TitleStrategy {
    ...
    static \u0275fac = function DefaultTitleStrategy_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _DefaultTitleStrategy)(i03.\u0275\u0275inject(Title));
    };
    static \u0275prov = /* @__PURE__ */ i03.\u0275\u0275defineInjectable({
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(DefaultTitleStrategy, [{
            type: Injectable3,
            args: [{
                    providedIn: "root"
                }]
...
var ROUTER_CONFIGURATION = new InjectionToken2(typeof ngDevMode === "undefined" || ngDevMode ? "router config" : "", {
    factory: () => ({})
});
var ROUTES = new InjectionToken2(typeof ngDevMode !== "undefined" && ngDevMode ? "ROUTES" : "");
        ...
        return __async(this, null, function* () {
            ...
            const loader = (() => __async(this, null, function* () {
                try {
                    ...
                    const component = yield maybeResolveResources(_maybeUnwrapDefaultExport(loaded));
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(RouterConfigLoader, [{
            type: Service2
        }], null, null);
})();
function loadChildren(route, compiler, parentInjector, onLoadEndListener) {
    return __async(this, null, function* () {
        ...
        const t = yield maybeResolveResources(_maybeUnwrapDefaultExport(loaded));
        let factoryOrRoutes;
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(UrlHandlingStrategy, [{
            type: Service2,
            args: [{
                    factory: () => inject2(DefaultUrlHandlingStrategy)
                }]
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(DefaultUrlHandlingStrategy, [{
            type: Service2
        }], null, null);
})();
var CREATE_VIEW_TRANSITION = new InjectionToken2(typeof ngDevMode !== "undefined" && ngDevMode ? "view transition helper" : "");
var VIEW_TRANSITION_OPTIONS = new InjectionToken2(typeof ngDevMode !== "undefined" && ngDevMode ? "view transition options" : "");
function createViewTransition(injector, from3, to) {
    const transitionOptions = injector.get(VIEW_TRANSITION_OPTIONS);
    const document2 = injector.get(DOCUMENT3);
...
var ACTIVATED_ROUTE_INJECTOR_FEATURE = new InjectionToken2(typeof ngDevMode === "undefined" || ngDevMode ? "ActivatedRoute injector feature" : "");
var noop = () => {
};
var NAVIGATION_ERROR_HANDLER = new InjectionToken2(typeof ngDevMode === "undefined" || ngDevMode ? "navigation error handler" : "");
var NavigationTransitions = class _NavigationTransitions {
    ...
    environmentInjector = inject2(EnvironmentInjector2);
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(NavigationTransitions, [{
            type: Service2
        }], () => [], null);
})();
...
var ROUTE_INJECTOR_CLEANUP = new InjectionToken2(typeof ngDevMode === "undefined" || ngDevMode ? "RouteInjectorCleanup" : "");
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(RouteReuseStrategy, [{
            type: Service2,
            args: [{
                    factory: () => inject2(DefaultRouteReuseStrategy)
                }]
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(DefaultRouteReuseStrategy, [{
            type: Service2
        }], null, null);
})();
var StateManager = class _StateManager {
    ...
    routerState = createEmptyState(null, inject2(EnvironmentInjector2));
    getRouterState() {
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(StateManager, [{
            type: Service2,
            args: [{
                    factory: () => inject2(HistoryStateManager)
                }]
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(HistoryStateManager, [{
            type: Service2
        }], null, null);
})();
...
var Router = class _Router {
    ...
    console = inject2(_Console2);
    stateManager = inject2(StateManager);
    options = inject2(ROUTER_CONFIGURATION, {
        optional: true
    }) || {};
    pendingTasks = inject2(_PendingTasksInternal);
    urlUpdateStrategy = this.options.urlUpdateStrategy || "deferred";
    navigationTransitions = inject2(NavigationTransitions);
    urlSerializer = inject2(UrlSerializer);
    location = inject2(Location);
    urlHandlingStrategy = inject2(UrlHandlingStrategy);
    injector = inject2(EnvironmentInjector2);
    _events = new Subject();
    get events() {
        return this._events;
    }
    ...
    parseUrl(url) {
        try {
            ...
            this.console.warn(_formatRuntimeError2(4018, ngDevMode && `Error parsing URL ${url}. Falling back to '/' instead. 
` + e));
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i03.\u0275setClassMetadata(Router, [{
            type: Service2
        }], () => [], null);
})();
function validateCommands(commands) {
    for (let i = 0; i < commands.length; i++) {
        ...
        if (cmd == null) {
            throw new _RuntimeError3(4008, (typeof ngDevMode === "undefined" || ngDevMode) && `The requested path contains ${cmd} segment at index ${i}`);
        }
    }
}
// node_modules/@angular/router/fesm2022/_router_module-chunk.mjs
import * as i3 from "@angular/common";
import { ViewportScroller, PlatformNavigation, PlatformLocation, \u0275PRECOMMIT_HANDLER_SUPPORTED as _PRECOMMIT_HANDLER_SUPPORTED, Location as Location2, LOCATION_INITIALIZED, \u0275NavigationAdapterForLocation as _NavigationAdapterForLocation, HashLocationStrategy, LocationStrategy as LocationStrategy2, PathLocationStrategy } from "@angular/common";
import * as i04 from "@angular/core";
import { inject as inject3, HostAttributeToken, linkedSignal, untracked as untracked2, signal as signal2, input as input2, \u0275INTERNAL_APPLICATION_ERROR_HANDLER as _INTERNAL_APPLICATION_ERROR_HANDLER2, effect, \u0275RuntimeError as _RuntimeError4, computed as computed2, booleanAttribute, Service as Service3, HostListener, Input as Input4, Attribute, Directive as Directive2, EventEmitter as EventEmitter2, Output as Output2, ContentChildren, createEnvironmentInjector as createEnvironmentInjector2, Injectable as Injectable4, InjectionToken as InjectionToken3, \u0275IS_HYDRATION_DOM_REUSE_ENABLED as _IS_HYDRATION_DOM_REUSE_ENABLED, NgZone as NgZone2, ApplicationRef as ApplicationRef2, EnvironmentInjector as EnvironmentInjector4, DestroyRef as DestroyRef2, afterNextRender as afterNextRender2, \u0275promiseWithResolvers as _promiseWithResolvers, \u0275publishNonCoreGlobalUtil as _publishNonCoreGlobalUtil, makeEnvironmentProviders as makeEnvironmentProviders3, APP_BOOTSTRAP_LISTENER as APP_BOOTSTRAP_LISTENER2, provideAppInitializer, \u0275IS_ENABLED_BLOCKING_INITIAL_NAVIGATION as _IS_ENABLED_BLOCKING_INITIAL_NAVIGATION2, Injector, provideEnvironmentInitializer, \u0275performanceMarkFeature as _performanceMarkFeature, ENVIRONMENT_INITIALIZER as ENVIRONMENT_INITIALIZER2, NgModule } from "@angular/core";
import { Subject as Subject2, of as of2, from as from2 } from "rxjs";
import { mergeAll, catchError as catchError2, filter as filter2, concatMap as concatMap2, mergeMap as mergeMap2, tap as tap2 } from "rxjs/operators";
var ReactiveRouterState = class _ReactiveRouterState {
    router = inject3(Router);
    stateManager = inject3(StateManager);
    ...
    serializer = inject3(UrlSerializer);
    constructor() {
        this.updateState();
    ...
    static \u0275prov = /* @__PURE__ */ i04.\u0275\u0275defineService({
        token: _ReactiveRouterState,
        factory: _ReactiveRouterState.\u0275fac
    });
};
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i04.\u0275setClassMetadata(ReactiveRouterState, [{
            type: Service3
        }], () => [], null);
})();
var RouterLink = class _RouterLink {
    ...
    el;
    locationStrategy;
    hrefAttributeValue = inject3(new HostAttributeToken("href"), {
        optional: true
    });
    ...
    browserUrl = input2(void 0, ...ngDevMode ? [{
            debugName: "browserUrl"
        }] : []);
    isAnchorElement;
    onChanges = new Subject2();
    applicationErrorHandler = inject3(_INTERNAL_APPLICATION_ERROR_HANDLER2);
    options = inject3(ROUTER_CONFIGURATION, {
        optional: true
    });
    reactiveRouterState = inject3(ReactiveRouterState);
        ...
        if (typeof ngDevMode !== "undefined" && ngDevMode) {
            effect(() => {
                if (isUrlTree(this.routerLinkInput()) && (this._fragment() !== void 0 || this._queryParams() || this._queryParamsHandling() || this._preserveFragment() || this._relativeTo())) {
                    throw new _RuntimeError4(4017, "Cannot configure queryParams or fragment when using a UrlTree as the routerLink input value.");
                }
            });
        }
    }
    ...
    static \u0275fac = function RouterLink_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _RouterLink)(i04.\u0275\u0275directiveInject(Router), i04.\u0275\u0275directiveInject(ActivatedRoute), i04.\u0275\u0275injectAttribute("tabindex"), i04.\u0275\u0275directiveInject(i04.Renderer2), i04.\u0275\u0275directiveInject(i04.ElementRef), i04.\u0275\u0275directiveInject(i3.LocationStrategy));
    };
    static \u0275dir = /* @__PURE__ */ i04.\u0275\u0275defineDirective({
        ...
        hostBindings: function RouterLink_HostBindings(rf, ctx) {
            if (rf & 1) {
                i04.\u0275\u0275listener("click", function RouterLink_click_HostBindingHandler($event) {
                    return ctx.onClick($event.button, $event.ctrlKey, $event.shiftKey, $event.altKey, $event.metaKey);
                });
            }
            if (rf & 2) {
                i04.\u0275\u0275attribute("href", ctx.reactiveHref(), i04.\u0275\u0275sanitizeUrlOrResourceUrl)("target", ctx._target());
            }
        },
        inputs: {
            target: "target",
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i04.\u0275setClassMetadata(RouterLink, [{
            type: Directive2,
            args: [{
                    selector: "[routerLink]",
                    host: {
...
var RouterLinkActive = class _RouterLinkActive {
    ...
    update() {
        if (!this.links || !this.router.navigated)
            return;
        if (this.routerLinkActiveOptions === null && !this._isActive)
            return;
        queueMicrotask(() => {
    ...
    static \u0275fac = function RouterLinkActive_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _RouterLinkActive)(i04.\u0275\u0275directiveInject(Router), i04.\u0275\u0275directiveInject(i04.ElementRef), i04.\u0275\u0275directiveInject(i04.Renderer2), i04.\u0275\u0275directiveInject(i04.ChangeDetectorRef));
    };
    static \u0275dir = /* @__PURE__ */ i04.\u0275\u0275defineDirective({
        ...
        contentQueries: function RouterLinkActive_ContentQueries(rf, ctx, dirIndex) {
            if (rf & 1) {
                i04.\u0275\u0275contentQuery(dirIndex, RouterLink, 5);
            }
            if (rf & 2) {
                let _t;
                i04.\u0275\u0275queryRefresh(_t = i04.\u0275\u0275loadQuery()) && (ctx.links = _t);
            }
        },
        inputs: {
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i04.\u0275setClassMetadata(RouterLinkActive, [{
            type: Directive2,
            args: [{
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i04.\u0275setClassMetadata(PreloadAllModules, [{
            type: Service3
        }], null, null);
})();
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i04.\u0275setClassMetadata(NoPreloading, [{
            type: Service3
        }], null, null);
})();
var RouterPreloader = class _RouterPreloader {
    ...
    static \u0275fac = function RouterPreloader_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _RouterPreloader)(i04.\u0275\u0275inject(Router), i04.\u0275\u0275inject(i04.EnvironmentInjector), i04.\u0275\u0275inject(PreloadingStrategy), i04.\u0275\u0275inject(RouterConfigLoader));
    };
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i04.\u0275setClassMetadata(RouterPreloader, [{
            type: Injectable4,
            args: [{
                    providedIn: "root"
                }]
...
var ROUTER_SCROLLER = new InjectionToken3(typeof ngDevMode !== "undefined" && ngDevMode ? "Router Scroller" : "");
var RouterScroller = class _RouterScroller {
    ...
    restoredId = 0;
    store = {};
    isHydrating = inject3(_IS_HYDRATION_DOM_REUSE_ENABLED, {
        optional: true
    }) ?? false;
    urlSerializer = inject3(UrlSerializer);
    zone = inject3(NgZone2);
    viewportScroller = inject3(ViewportScroller);
    transitions = inject3(NavigationTransitions);
    constructor(options) {
        this.options = options;
        this.options.scrollPositionRestoration ||= "disabled";
        this.options.anchorScrolling ||= "disabled";
        if (this.isHydrating) {
            inject3(ApplicationRef2).whenStable().then(() => {
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i04.\u0275setClassMetadata(RouterScroller, [{
            type: Injectable4
        }], () => [{
            type: void 0
        }], null);
...
var NavigationStateManager = class _NavigationStateManager extends StateManager {
    injector = inject3(EnvironmentInjector4);
    navigation = inject3(PlatformNavigation);
    inMemoryScrollingEnabled = inject3(ROUTER_SCROLLER, {
        optional: true
    }) !== null;
    base = new URL(inject3(PlatformLocation).href).origin;
    appRootUrl = new URL(this.location.prepareExternalUrl?.("/") ?? "/", this.base);
    precommitHandlerSupported = inject3(_PRECOMMIT_HANDLER_SUPPORTED);
    ...
    constructor() {
        ...
        inject3(DestroyRef2).onDestroy(() => this.navigation.removeEventListener("navigate", navigateListener));
    }
    registerNonRouterCurrentEntryChangeListener(listener) {
    ...
    eventAndRouterDestinationsMatch(navigateEvent, transition) {
        ...
        return destSearch === eventDestSearch && hashDest === eventDestHash && Location2.stripTrailingSlash(destPathname) === Location2.stripTrailingSlash(eventDestPathname);
    }
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i04.\u0275setClassMetadata(NavigationStateManager, [{
            type: Service3
        }], () => [], null);
})();
...
function setupActivatedRouteInjectors() {
    return tap2(({ newlyCreatedRoutes, targetRouterState }) => {
...
function setupNewActivatedRouteInjector(snapshot, route) {
    ...
    route._localInjector = createEnvironmentInjector2([], snapshot._environmentInjector);
}
function provideRouter(routes, ...features) {
    ...
    return makeEnvironmentProviders3([{
            provide: ROUTES,
            multi: true,
            useValue: routes
        }, {
            ...
            provide: APP_BOOTSTRAP_LISTENER2,
            multi: true,
            useFactory: getBootstrapListener
        }, features.map((feature) => feature.\u0275providers)]);
}
function rootRoute() {
    return inject3(Router).routerState.root;
}
...
function withExperimentalPlatformNavigation() {
    const devModeLocationCheck = typeof ngDevMode === "undefined" || ngDevMode ? [provideEnvironmentInitializer(() => {
            const locationInstance = inject3(Location2);
...
function getBootstrapListener() {
    const injector = inject3(Injector);
    return (bootstrappedComponentRef) => {
        const ref = injector.get(ApplicationRef2);
...
var BOOTSTRAP_DONE = new InjectionToken3(typeof ngDevMode === "undefined" || ngDevMode ? "bootstrap done indicator" : "", {
    factory: () => {
        return new Subject2();
    }
});
var INITIAL_NAVIGATION = new InjectionToken3(typeof ngDevMode === "undefined" || ngDevMode ? "initial navigation" : "", {
    factory: () => 1
});
function withEnabledBlockingInitialNavigation() {
    const providers = [{
            provide: _IS_ENABLED_BLOCKING_INITIAL_NAVIGATION2,
            useValue: true
        }, {
...
function withDisabledInitialNavigation() {
    const providers = [provideAppInitializer(() => {
            inject3(Router).setUpLocationChangeListener();
        }), {
            provide: INITIAL_NAVIGATION,
            useValue: 2
        }];
...
var ROUTER_PRELOADER = new InjectionToken3(typeof ngDevMode === "undefined" || ngDevMode ? "router preloader" : "");
...
var ROUTER_FORROOT_GUARD = new InjectionToken3(typeof ngDevMode === "undefined" || ngDevMode ? "router duplicate forRoot guard" : "");
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i04.\u0275setClassMetadata(RouterModule, [{
            type: NgModule,
            args: [{
...
function provideRouterScroller() {
    return {
        provide: ROUTER_SCROLLER,
        useFactory: () => {
            const viewportScroller = inject3(ViewportScroller);
            const config = inject3(ROUTER_CONFIGURATION);
...
function provideForRootGuard() {
    ...
    if (router) {
        throw new _RuntimeError4(4007, `The Router was provided more than once. This can happen if 'forRoot' is used outside of the root injector. Lazy loaded modules should use RouterModule.forChild() instead.`);
    }
    return "guarded";
}
...
var ROUTER_INITIALIZER = new InjectionToken3(typeof ngDevMode === "undefined" || ngDevMode ? "Router Initializer" : "");
...
import { inject as inject4, Version as Version2 } from "@angular/core";
import "@angular/common";
import "rxjs";
import "rxjs/operators";
function mapToCanMatch(providers) {
    return providers.map((provider) => (...params) => inject4(provider).canMatch(...params));
}
function mapToCanActivate(providers) {
    return providers.map((provider) => (...params) => inject4(provider).canActivate(...params));
}
function mapToCanActivateChild(providers) {
    return providers.map((provider) => (...params) => inject4(provider).canActivateChild(...params));
}
function mapToCanDeactivate(providers) {
    return providers.map((provider) => (...params) => inject4(provider).canDeactivate(...params));
}
function mapToResolve(provider) {
    return (...params) => inject4(provider).resolve(...params);
}
var VERSION = /* @__PURE__ */ new Version2("22.1.1");
