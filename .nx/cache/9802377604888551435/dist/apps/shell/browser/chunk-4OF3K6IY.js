import { BASE_EFFECT_NODE, SIGNAL, consumerDestroy, createComputed, createLinkedSignal, createSignal, getActiveConsumer, isInNotificationPhase, linkedSignalSetFn, linkedSignalUpdateFn, runEffect, setActiveConsumer, untracked } from "@nf-internal/chunk-MQ44NPZ3";
import { getCurrentInjector, isNotFound, setCurrentInjector } from "@nf-internal/chunk-SPLD4HVS";
...
function resource(options) {
    ...
    return new ResourceImpl(params, getLoader(options), options.defaultValue, options.equal ? wrapEqualityFn(options.equal) : void 0, options.debugName, options.injector ?? inject(Injector), options.id);
}
