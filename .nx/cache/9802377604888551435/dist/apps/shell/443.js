...
/* harmony import */ var _xhr_chunk_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_xhr-chunk.mjs */ 7516);
/* harmony import */ var _platform_location_chunk_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./_platform_location-chunk.mjs */ 8963);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs */ 8830);
  ...
  class HttpXsrfCookieExtractor {
    ...
    getToken() {
      ...
      if (cookieString !== this.lastCookieString) {
        this.parseCount++;
        this.lastToken = (0,_xhr_chunk_mjs__WEBPACK_IMPORTED_MODULE_3__.parseCookieValue)(cookieString, this.cookieName);
...
function xsrfInterceptorFn(req, next) {
  ...
  try {
    const locationHref = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_platform_location_chunk_mjs__WEBPACK_IMPORTED_MODULE_4__.PlatformLocation).href;
    const {
  ...
  class HttpInterceptorHandler {
    ...
    handle(initialRequest) {
      ...
      if (this.contributeToStability) {
        ...
        return (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.untracked)(() => chain(initialRequest, downstreamRequest => this.backend.handle(downstreamRequest))).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.finalize)(removeTask));
      } else {
...
let HttpClient = /*#__PURE__*/(() => {
  class HttpClient {
    ...
    request(first, url, options = {}) {
      ...
      const events$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)(req).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.concatMap)(req => this.handler.handle(req)));
...
let HttpXhrBackend = /*#__PURE__*/(() => {
  class HttpXhrBackend {
    ...
    handle(req) {
      ...
      const source = typeof ngServerMode !== 'undefined' && ngServerMode && xhrFactory.ɵloadImpl ? (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.from)(xhrFactory.ɵloadImpl()) : (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)(null);
    ...
    static ɵfac = function HttpXhrBackend_Factory(__ngFactoryType__) {
      /* @ts-ignore */
      return new (__ngFactoryType__ || HttpXhrBackend)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_xhr_chunk_mjs__WEBPACK_IMPORTED_MODULE_3__.XhrFactory));
    };
    static ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ 2814);
/**
 * @license Angular v22.1.1
 * (c) 2010-2026 Google LLC. https://angular.dev/
 * License: MIT
