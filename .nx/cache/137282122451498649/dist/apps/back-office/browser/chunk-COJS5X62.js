import { F as on, G as sn, H as ge, I as pe, J as an, K as un, a as D, b as w, c as nn, s as le, w as tn, y as rn } from "@nf-internal/chunk-AGHEGZ63";
import { a as fe, b as E, f as he } from "@nf-internal/chunk-Q4YTATXA";
...
}, cn = new ve("22.1.1"), Tt = (() => { let e = cn.full; return `https://${e.includes("-next") || e.includes("-rc") || e === "0.0.0-PLACEHOLDER" ? "next" : `v${cn.major}`}.angular.dev`; })(), mo = `${Tt}/errors`, vo = "https://angular.dev/best-practices/security#preventing-cross-site-scripting-xss", h = class extends Error {
    code;
