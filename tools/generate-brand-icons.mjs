#!/usr/bin/env node
/**
 * Rasterize branding/logo.svg into PNG/ICO for Capacitor and Electron.
...
async function main() {
  ...
  console.log('Run npx @capacitor/assets generate on the Capacitor branch for platform icons.');
}
